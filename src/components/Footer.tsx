        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-x-4 gap-y-4 sm:gap-8 md:gap-8 mb-6 sm:mb-8 md:mb-10">
            ...
            >
              ...
              <div className="flex space-x-3 sm:space-x-4 mt-4 pb-5">
                <a href="https://www.facebook.com/brasizecalculator" target="_blank" aria-label="Facebook">
                  <svg
                ...
                <a href="https://x.com/brasizecalculator" target="_blank" aria-label="X">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                ...
                <a href="https://www.youtube.com/@brasizecalculator" target="_blank" aria-label="YouTube">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                ...
                <a href="https://www.pinterest.com/brasizecalculator
