...
export const metadata: Metadata = {
  ...
  keywords: "privacy policy, data protection, personal information, bra size calculator",
  openGraph: {
    title: "Privacy Policy | Bra Size Calculator",
    description: "Privacy policy for the Bra Size Calculator website"
  }
  ...
  return (
    <div className="relative min-h-screen">
      <div className="relative z-10 container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold font-rubik mb-8">Privacy Policy</h1>

        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold font-rubik mb-4">Introduction</h2>
          ...
          <h2 className="text-2xl font-semibold font-rubik mb-4 mt-8">
          ...
          <h3 className="text-xl font-medium font-rubik mb-2 mt-4">Personal Data</h3>
          <p className="mb-4 font-lato">
          ...
          <h3 className="text-xl font-medium font-rubik mb-2 mt-4">Derivative Data</h3>
          <p className="mb-4 font-lato">
          ...
          <h3 className="text-xl font-medium font-rubik mb-2 mt-4">Financial Data</h3>
          <p className="mb-4 font-lato">
          ...
          <h3 className="text-xl font-medium font-rubik mb-2 mt-4">
          ...
          <h2 className="text-2xl font-semibold font-rubik mb-4 mt-8">Contact Us</h2>
          <p className="mb-4 font-lato">
