      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="mb-4">
            ...
            ("you") and our company ("we," "us" or "our"), concerning your
          ...
          <h2 className="text-2xl font-semibold mb-4 mt-8">Returns Policy</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold mb-4 mt-8">Site Management</h2>
          <p className="mb-4">
